...
const ProductCard = ({ price, category, name, image }) => {
    return (
        <div className='bg-white relative h-[441.73px] mt-[130px] rounded-[20px] mx-[24px] max-md:w-[95%] max-md:mx-0'>
            <div className='relative bg-product-bg h-[239.15px] mb-[13.71px] rounded-[20px]'>
                <img src={image} alt="product" className='absolute top-[-67px] left-[22px] max-[999px]:left-[94px] max-lg:left-[49px] max-md:left-[146px] max-[493px]:left-[133px] max-[413px]:left-[42px] transition-all duration-500 cursor-pointer hover:scale-110' />
            </div>
